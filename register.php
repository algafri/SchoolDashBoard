...
<html lang="en">
  ...
  <body class="bg-dark" style="background-image: linear-gradient(#1f1709, #2144);
    background-color: #ebdb22!important;">

    <div class="container">
      <div class="card card-register mx-auto mt-5">
        <div class="card-header"><img src="image/IMG-20200128-WA0000.jpg " style="width: 103px;
    border-radius: 57px;"></div>
        <div class="card-body">
          <form method="POST" action="success1.php">
            ...
            <button type="submit" class="btn btn-primary btn-block" name="register" style="background-image: linear-gradient(, #2144); background-color: #78410b;">Register</button>
          </form>
